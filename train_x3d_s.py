...
#     # ⚠️ IMPORTANT: On Windows CPU use num_workers=0
...
#             torch.save(model.state_dict(), "x3d_s_best.pth")
#             print("✅ Best model saved!")

#     torch.save(model.state_dict(), "x3d_s_final.pth")
#     print("\n🎉 Training complete.")
    
    
#     label_map = {}
#     for path, label in LabeledVideoPaths.from_directory(DATA_PATH_TRAIN)._paths_and_labels:
...
NUM_CLASSES   = 3
BATCH_SIZE    = 1           # X3D-S is lighter, can afford batch size 2
NUM_EPOCHS    = 30
CLIP_DURATION = 2.0        # safe middle ground for your 2–3 s clips
LEARNING_RATE = 1e-4

# X3D-S specific parameters
NUM_FRAMES   = 13          # X3D-S paper: 13 frames
SPATIAL_SIZE = 160          # X3D-S paper: 160 x 160
